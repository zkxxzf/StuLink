...
def download_template():
    ...
    # 新顺序：核心信息→宿舍模块（更符合使用习惯）
    headers = ['学号', '姓名', '性别', '民族', '身份证号', '学籍情况', '学籍备注',
               '年级', '班级', '联系方式 1', '联系方式 2',
               '毕业学校代码', '毕业学校',
               '原班级', '选科', '住校/走读', '出门权限', '课本', '班主任备注']
    ...
    widths = [15, 10, 8, 8, 22, 10, 20, 10, 8, 15, 15, 12, 25, 10, 10, 10, 10, 10, 25]
    for i, w in enumerate(widths, 1):
        ws.column_dimensions[openpyxl.utils.get_column_letter(i)].width = w

    ws.append(['20251001', '张三', '男', '汉族', '110101200801011234', '借读', '',
               '2025 级', '01 班', '13800138000', '',
               '0440', '郑州市管城回族区第二中学',
               '', '史政地', '住校', '', '', ''])
            ...
            if update_mode and snum in existing_snum_map:
                ...
                if student:
                    ...
                    for field in ['ethnicity','grade','class_name',
                                  'phone1','phone2','original_class','subject_selection',
                                  'boarding_type','day_student_type','enrollment_status',
                                  'textbook','teacher_notes','enrollment_notes',
                                  'graduation_school_code','graduation_school']:
