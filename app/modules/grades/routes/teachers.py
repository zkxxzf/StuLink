...
def teacher_template_download():
    ...
    ws.append(['2025级', '01班', '史政地', '敬鹏超', '蒋莹', '',
               '蒋莹', '聂志远', '袁菁', '', '', '', '时康莉', '敬鹏超', '张葛'])
    ws.append(['2025级', '02班', '史政地', '张瑾珂', '陈丽莉', '',
               '张瑾珂', '雷坤', '魏梦媛', '', '', '', '陈丽莉', '杨京辉', '陈曦'])
    ws.append(['2024级', '01班', '史政地', '刘稳', '郭艳静', '',
               '刘稳', '李灿灿', '任润萌', '', '', '', '邓梦桐', '郭艳静', '彭慧兰'])
